...
constexpr long OFF_IN_DUCK = 0x07383cf0;                       //[Buttons]->in_duck
constexpr long OFFSET_IN_FORWARD = 0x07383d30;                       //[Buttons]->in_forward
...
constexpr long OFF_VIEW_RENDER = 0x73828a0;                   //[RecvTable.DT_Player]->ViewRender
